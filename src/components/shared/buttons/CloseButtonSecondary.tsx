...
export default function CloseButtonSecondary({
  ...
  return (
    <button
      ...
      className="absolute top-3 right-3 laptop:top-4 laptop:right-4 flex justify-center items-center h-8 w-8 tablet:h-10 tablet:w-10 text-primary laptop:hover:text-accent 
