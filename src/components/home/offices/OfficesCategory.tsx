...
export default function OfficesCategory({
  ...
  return (
    <div className="tablet:w-[48.9%] laptop:w-[32.5%]">
      <OfficesSlider sliderList={sliderList} />
      <div className="flex items-center justify-center h-10 mt-[3.43%] border border-primary text-primary text-baseb laptop:text-mdb">
        {categoryName}
      </div>
    </div>
  );
