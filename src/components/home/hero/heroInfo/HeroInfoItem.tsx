...
export default function HeroInfoItem({ heroInfoItem }: HeroInfoItemProps) {
  ...
  return (
    ...
    tablet:[&:nth-child(3)]:right-[35.9%] [&:nth-child(3)]:top-[30.3%] mobileXl:[&:nth-child(3)]:top-[33%] tablet:[&:nth-child(3)]:top-[31.4%] last:top-[43.5%] mobileXl:last:top-[33%] tablet:last:top-[31.4%] 
    last:right-[5.55%] tablet:last:right-[20.8%] flex flex-col items-center justify-center w-[24.44%] h-[20%] mobileXl:w-[30.5%] mobileXl:h-[24.96%] tablet:w-[13%] tablet:h-[17.6%]"
    >
      <Image
